classdef emissionRate
    ...
    methods
        function rate = emissionRate(overLap,MMElement,waveLength)
            ...
            rate.hw = flip(h*c0./rate.wavLen /q); % unit of Joule to eV
        ...
        function rate = updateC(rate)
            ...
            rate.C1 = rate.nr^2.*rate.w.^2/pi^2/h_b/c0^2; % SI unit
        end
        ...
        function rate = getSponRate(rate)
            global q;
            rate.r_sp_CH1 = rate.oL.Ic1_hh1*rate.C0.*rate.C1.*1.5*rate.mmE.C1_HH1.*rate.rho_CH1.*rate.fc_c1_hh1.*(1-rate.fv_c1_hh1)*q;
            rate.r_sp_CL1 = rate.oL.Ic1_lh1*rate.C0.*rate.C1.*0.5*rate.mmE.C1_LH1.*rate.rho_CL1.*rate.fc_c1_lh1.*(1-rate.fv_c1_lh1)*q;
            rate.r_sp_CH2 = rate.oL.Ic2_hh2*rate.C0.*rate.C1.*1.5*rate.mmE.C2_HH2.*rate.rho_CH2.*rate.fc_c2_hh2.*(1-rate.fv_c2_hh2)*q;
            rate.r_sp_CL2 = rate.oL.Ic2_lh2*rate.C0.*rate.C1.*0.5*rate.mmE.C2_LH2.*rate.rho_CL2.*rate.fc_c2_lh2.*(1-rate.fv_c2_lh2)*q;
